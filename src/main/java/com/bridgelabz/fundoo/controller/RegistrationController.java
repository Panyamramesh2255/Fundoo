...
public class RegistrationController {
	 ...
	 */
	@GetMapping("/login")
	public ResponseEntity<Response> login(@Valid @RequestBody LoginDto loginDto) throws LoginException, javax.security.auth.login.LoginException {
		Response response = registrationservice.verify(loginDto);
	...
	public ResponseEntity<Response> decode(@RequestHeader String token, @RequestHeader String password) {
		...
		System.out.println("found by email... "+decodedstring);
	...
	public ResponseEntity<Response> delete(@RequestParam String id, @RequestHeader String token) {
		Response response=registrationservice.delete(id);
		return new ResponseEntity<Response>(response, HttpStatus.OK);
	}
